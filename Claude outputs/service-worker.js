...
// （包括 ./ 前缀和 ?v=94 这种查询参数），因为预缓存是按URL字符串存的，差一个字符就命中不了。
// 加了新的 js 模块 / 第三方库之后，记得同步加到这里，否则离线时那个模块会加载失败。
const CORE_ASSETS = [
    './',
    './index.html',
    './style.css?v=94',   // ⚠️ 跟 index.html 里的 ?v= 必须完全一致，改一处就要改两处
    ...
    './js/vendor/localforage.min.js?v=94',
    './js/vendor/mammoth.browser.min.js?v=94',
    './js/vendor/ejs.min.js?v=94',
    // 角色卡前端页面（开场白菜单/状态栏）里用到 $ 的那些，会由 js/03 往 iframe 里挂这个 <script src>；
    // 不预缓存的话离线时那些卡片会报 "$ is not defined" 整张卡死掉
    './js/vendor/jquery.min.js?v=94',
    './js/01-core-state-infra.js?v=94',
    './js/02-databank-plugins-minigames.js?v=94',
    './js/03-markdown-feed-tags.js?v=94',
    './js/04-mobile-bootstrap-notifications.js?v=94',
    './js/05-anniversary-memory.js?v=94',
    './js/06-emoticons-time-humanfeel-relationships-worldbook.js?v=94',
    './js/07-proactive-cloudsync.js?v=94',
    './js/08-diary-novel.js?v=94',
    './js/09-memories-search-postfixes.js?v=94',
    './js/10-comments-npc-forum-reply.js?v=94',
    './js/11-tabloid-story-forum-engine.js?v=94',
    './js/12-worldbook-import-appexport.js?v=94',
    './js/13-charreply-groupchat-faction-cardimport.js?v=94',
    './js/14-settings-archive.js?v=94',
    './js/15-ai-presets.js?v=94',
    './js/16-story-studio.js?v=94',
    './js/17-tavern-bridge.js?v=94',
    './js/18-minigames-board-cards.js?v=94',
    './js/19-minigames-party.js?v=94',
    './js/20-reading-together.js?v=94',
    './js/21-watch-together.js?v=94'
];

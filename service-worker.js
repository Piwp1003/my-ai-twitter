...
// （包括 ./ 前缀和 ?v=112 这种查询参数），因为预缓存是按URL字符串存的，差一个字符就命中不了。
// 加了新的 js 模块 / 第三方库之后，记得同步加到这里，否则离线时那个模块会加载失败。
const CORE_ASSETS = [
    './',
    './index.html',
    './style.css?v=112',   // ⚠️ 跟 index.html 里的 ?v= 必须完全一致，改一处就要改两处
    ...
    './js/vendor/localforage.min.js?v=112',
    './js/vendor/mammoth.browser.min.js?v=112',
    './js/vendor/ejs.min.js?v=112',
    // 角色卡前端页面（开场白菜单/状态栏）里用到 $ 的那些，会由 js/03 往 iframe 里挂这个 <script src>；
    // 不预缓存的话离线时那些卡片会报 "$ is not defined" 整张卡死掉
    './js/vendor/jquery.min.js?v=112',
    './js/01-core-state-infra.js?v=112',
    './js/02-databank-plugins-minigames.js?v=112',
    './js/03-markdown-feed-tags.js?v=112',
    './js/04-mobile-bootstrap-notifications.js?v=112',
    './js/05-anniversary-memory.js?v=112',
    './js/06-emoticons-time-humanfeel-relationships-worldbook.js?v=112',
    './js/07-proactive-cloudsync.js?v=112',
    './js/08-diary-novel.js?v=112',
    './js/09-memories-search-postfixes.js?v=112',
    './js/10-comments-npc-forum-reply.js?v=112',
    './js/11-tabloid-story-forum-engine.js?v=112',
    './js/12-worldbook-import-appexport.js?v=112',
    './js/13-charreply-groupchat-faction-cardimport.js?v=112',
    './js/14-settings-archive.js?v=112',
    './js/15-ai-presets.js?v=112',
    './js/16-story-studio.js?v=112',
    './js/17-tavern-bridge.js?v=112',
    './js/18-minigames-board-cards.js?v=112',
    './js/19-minigames-party.js?v=112',
    './js/20-reading-together.js?v=112',
    './js/21-watch-together.js?v=112',
    './js/22-box-music.js?v=112',
    './js/23-box-map.js?v=112',
    './js/24-box-relations.js?v=112',
    './js/25-box-life.js?v=112',
    './js/26-box-mall.js?v=112',
    './js/27-feature-pages.js?v=112',
    './js/28-invite-in-chat.js?v=112',
    './js/29-web-explore.js?v=112',
    './js/30-parcel-cards.js?v=112',
    './js/31-wallet.js?v=112',
    './js/32-takeout.js?v=112',
    './js/33-phone.js?v=112',
    './js/34-gallery.js?v=112',
    './js/35-dressup.js?v=112',
    './js/36-silence.js?v=112',
    './js/37-inject-hub.js?v=112'
];

...
const CORE_ASSETS = [
    ...
    './js/04-mobile-bootstrap-notifications.js',
    './js/05-anniversary-memory.js',
    './js/06-emoticons-time-humanfeel-relationships-worldbook.js',
    './js/07-proactive-cloudsync.js',
    './js/08-diary-novel.js',
    './js/09-memories-search-postfixes.js',
    './js/10-comments-npc-forum-reply.js',
    './js/11-tabloid-story-forum-engine.js',

...
function addCharAnniversaryWithSync() {
    ...
    let charId = (typeof currentChatSessionId !== 'undefined' && currentChatSessionId) ? currentChatSessionId : null;
    if (!charId && typeof viewingCharId !== 'undefined') charId = viewingCharId;
    if (!charId && typeof currentProfileCharId !== 'undefined') charId = currentProfileCharId;
    let char = null;
